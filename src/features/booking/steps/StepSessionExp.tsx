...
const EXPERIENCES: Experience[] = [
  {
    ...
    tags: ['60 min', 'Video call', 'Personalised'],
    mood: 'intimate',
  },
  {
    id: 'shared-circle',
  ...
  },
  {
    ...
    subtitle: 'Private session · Hosted at our space',
    description: 'Visit our wellness space for a calming in-person experience rooted in presence and healing.',
    tags: ['60 min', 'In-person', 'Private'],
    mood: 'sacred',
  },
  {
    id: 'group-wellness',
    ...
    subtitle: 'Community · Hosted at our space',
    description: 'Come together in our space for an immersive group session centered around sound, movement, and mindful presence.',
    tags: ['60 min', 'In-person', 'Community'],
    mood: 'communal',
  },
]
